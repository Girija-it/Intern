  ...
  return (
    <div className="w-full">
      ...
      <div className="absolute h-[57vh] bg-[#FCDD9B] w-[100%]">
        ...
        >
          <div
            className="h-[62vh] xl:w-[30%] md:w-[45%] sm:w-[55%] w-[80%] xl:ml-[0] lg:ml-[2%] 
          md:left-[5%] lg:left-0 sm:ml-[20%] ml-[12%] flex relative md:justify-center md:items-center md:mb-0 mb-5"
          >
            <InputTab
