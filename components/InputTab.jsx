...
const InputTab = ({
  ...
  return (
    <>
      <div className="w-full xl:ml-5 lg:ml-0 ml-5 xl:mr-10 lg:mr-5 mr-10 bg-white h-[62vh] rounded-3xl shadow-lg shadow-slate-700/40 relative block justify-center items-center mb-[10%] lg:mb-0">
        ...
        <div className="h-[39vh] mt-3 relative">
          ...
          <div className="flex items-center justify-evenly w-[100%] h-[7vh] xl:mt-7 mt-3 ">
            <button
